    ...
    <div class="container">
      ...
      if(isset($_POST['submit'])) 
      {
        ...
        if($name!="" && $email !="") 
        {
          ...
          if($result)
          {
            echo header("Location:managestudent.php?msg=addsuccess");
          }
          else 
          {
            echo header("Location:managestudent.php?msg=adderror");
          }
        }
        else
        {
          echo header("Location:managestudent.php?msg=fieldmust");
        }
      }
      ?>
        <div class="row">
